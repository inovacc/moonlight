...
import (
	...
	"github.com/inovacc/moonlight/pkg/module/internal/vcweb"
	web2 "github.com/inovacc/moonlight/pkg/module/internal/web"
	"io"
	"log"
	"net/http"
	"net/http/httptest"
...
func NewServer() (srv *Server, err error) {
	...
	var interceptors []web2.Interceptor
	for _, host := range Hosts {
		interceptors = append(interceptors,
			web2.Interceptor{Scheme: "http", FromHost: host, ToHost: httpURL.Host, Client: srv.HTTP.Client()},
			web2.Interceptor{Scheme: "https", FromHost: host, ToHost: httpsURL.Host, Client: srv.HTTPS.Client()})
	}
	web2.EnableTestHooks(interceptors)
