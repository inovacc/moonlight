...
import (
	...
	"moduleList/sup/internal/modfetch"
	"moduleList/sup/internal/modfetch/codehost"
	"moduleList/sup/internal/pkgpattern"
...
func queryReuse(ctx context.Context, path, query, current string, allowed AllowedFunc, reuse map[module.Version]*ModulePublic) (*modfetch.RevInfo, error) {
...
func queryProxy(ctx context.Context, proxy, path, query, current string, allowed AllowedFunc, reuse map[module.Version]*ModulePublic) (*modfetch.RevInfo, error) {
